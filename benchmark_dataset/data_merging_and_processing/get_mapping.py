...
df = pd.read_csv("/Users/bellavg/PycharmProjects/DIG_FACT/benchmark_dataset/encoded_data_wo_religions.csv")
...
with_twit = pd.read_csv("/Users/bellavg/PycharmProjects/DIG_FACT/benchmark_dataset/encoded_data.csv")
with_twit.to_csv("/Users/bellavg/PycharmProjects/DIG_FACT/benchmark_dataset/w_twit_encoded_data.csv")
